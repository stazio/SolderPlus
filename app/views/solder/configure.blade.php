        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
            	...
            	<div class="form-group">
                    ...
                    <input type="text" class="form-control" name="mirror_url" id="mirror_url" value="{{ ConfUtils::get('solder.mirror_url') }}"  disabled>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="repo_location" id="repo_location" value="{{ ConfUtils::get('solder.repo_location') }}"  disabled>
                    <span class="help-block">This is the location of your mod repository. This can be a URL or an absolute file location(faster). When an absolute file location is used, Solder will attempt to calculate the MD5 checksum internally instead of over the remote web request.</span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="md5_connect_timeout" id="md5_connect_timeout" value="{{ ConfUtils::get('solder.md5_connect_timeout') }}"  disabled>
                        <span class="help-block">This is the amount of time (in seconds) Solder will wait before giving up trying to connect to a URL to perform a MD5 checksum.</span>
                    </div>
